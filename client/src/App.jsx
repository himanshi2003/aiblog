...
const makeRequestAPI = async (prompt) => {
  const res = await axios.post("https://aiblog-o55l.onrender.com/generate", { prompt });
    ...
    const fetchYouTubeVideos = async () => {
      try {
        const response = await axios.get('https://www.googleapis.com/youtube/v3/search', {
          params: {
            part: 'snippet',
            channelId: "UCbpHVFHzSIyZS31GkWdSnSQ",
            maxResults: 10,
            order: 'date',
            type: 'video',
            key: "AIzaSyBvfEaylpZGexzG1xUEHKCuea62yXLeSGI"
          },
        });
